...
<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			if ( $nightrun_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $nightrun_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
			<svg class="title-decoration back" height="250" width="450">
  			<polygon points="15,45 75,200 380,110" style="fill:rgba(0,0,0,0);stroke:#FF6C11;stroke-width:10;" />
			</svg>
			<svg class="title-decoration front" height="250" width="450">
